	...
	public int RequestApproved(AccOpenManagementDTO dto) {
		...
		try {
			...
			String sql = "UPDATE account_common "
					+ "SET ac_open_situation = 1, ac_startDate = TO_CHAR(sysdate, 'YYYY/MM/DD HH24:MI:SS'), ac_endDate = DECODE(?, 'null', 'null', TO_CHAR(ADD_MONTHS(sysdate, ?), 'YYYY/MM/DD HH24:MI:SS')) "
