...
https://cdn.jsdelivr.net/npm/sweetalert2@11.7.5/dist/sweetalert2.all.min.js">
			...
			<body>
				...
				%>
					...
					<% return; } MemberDAO memberDao=new MemberDAO(); MemberDTO memInfo=memberDao.selectMember((String)
						session.getAttribute("id")); String memName=memInfo.getName(); String memSsn=memInfo.getSsn();
						%>
						<%@ include file="navBar.jsp" %>
							<div class="noticeWrapper">
								...
								<form name="savingCreateForm" action="createNormal_proc.jsp">
									...
									<label>이름 <input type="text" id="name" name="name" class="form-control"
											placeholder="이름" readOnly value="<%=memName%>">
									</label> <br>
									<div class="ssnInput">
										<label style="display: block;">주민번호</label>
										<input type="text" class="form-control" required name="ssn1" id="inputSsn1"
											placeholder="주민번호 앞자리" autoComplete="false" readOnly
											value="<%=memSsn.substring(0, 6)%>"><input type="password"
											class="form-control" required name="ssn2" id="inputSsn2"
											placeholder="주민번호 뒷자리" autoComplete="false" readOnly
											value="<%=memSsn.substring(6, 13)%>">
									</div>
									<div class="pwInput">
										<label> 신규 비밀번호 <input type="password" id="pw1" name="pw1"
												placeholder="신규계좌 비밀번호" required class="form-control" minLength="4" maxLength="4">
										</label><label> 신규 비밀번호 확인 <input type="password" id="pw2" name="pw2"
												placeholder="신규계좌 비밀번호 확인" required class="form-control" minLength="4" maxLength="4">
										</label>
									</div>
