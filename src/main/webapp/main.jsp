		...
		<%@ include file="navBar.jsp" %>
			...
			<div class="mainContent1">
				...
				<div class="imgWrapper">
					<img src="./imgs/main1.png" class="mainImg" width="100%" height="100%" />
				</div>
			</div>
			<div class="productIntroduce">
				...
				<ul class="products">
					...
					<li><a href="./loanIntroduce.jsp"> <span class="productKeyword">대출</span> <span class="productImg">
								<img src="./imgs/signing.png" />
							</span> 삼편한 직장인대출S
